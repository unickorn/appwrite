...
class Bucket extends Model
{
    public function __construct()
    {
        $this
            ...
            ->addRule('compression', [
                'type' => self::TYPE_STRING,
                'description' => 'Compression algorithm choosen for compression. Will be one of ' . COMPRESSION_TYPE_NONE . ', [' . COMPRESSION_TYPE_GZIP . '](https://en.wikipedia.org/wiki/Gzip), [' . COMPRESSION_TYPE_ZSTD . '](https://en.wikipedia.org/wiki/Zstd), or [' . COMPRESSION_TYPE_XZ . '](https://en.wikipedia.org/wiki/XZ_Utils).',
                'default' => '',
                'example' => 'gzip',
                'array' => false
            ])
